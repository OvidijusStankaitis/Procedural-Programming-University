...
int main(int argc, char *argv[]) {
    ...
    if (db){                            
	    ...
	    int statusasC = 0, statusasA = 0;
	    char CALC[30] = "Calculus", ALG[30] = "Algebra";

	    for(int u = 0; u < s.load; u++)
	    {
		if(strcmp(s.courses[u],CALC) == 0)	
		{
			statusasC = 1;
		}
		...
		if(strcmp(s.courses[u],ALG) == 0)
		{
            ...
            if(statusasC == 1 || statusasA == 1){ // *** first filter, conditions on the student
